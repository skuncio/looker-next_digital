view: content_preference_total_views {
  derived_table: {
# This view does not declare a primary_key dimension. Some measures will not be available if this view is joined as many_to_one or one_to_one.
    sql: SELECT
