...
explore: t3016_seg_agg_cid_day {
  ...
  join: t1025_reg_prod_cid_title {
    ...
    sql_on: c3016_cid  = ${t1025_reg_prod_cid_title.c1025_cid} and c3016_productt = ${t1025_reg_prod_cid_title.c1025_product} and c3016_region = ${t1025_reg_prod_cid_title.c1025_region} and c3016_imp_type = ${t1025_reg_prod_cid_title.c1025_imp_type}  ;;
